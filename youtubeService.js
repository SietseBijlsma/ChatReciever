...
const clientId = '18034501813-ro2u8qg8rl21p1ck164jef0j1vkek8ap.apps.googleusercontent.com';
const clientSecret = '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';
...
const getChatMessages = async () => {
  ...
  chatMessages.forEach(element => {
    console.log("Youtube Message:" + element.snippet.displayMessage);
  });
};
